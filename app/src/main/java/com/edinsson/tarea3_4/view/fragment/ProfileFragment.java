...
import com.edinsson.tarea3_4.adapter.PictureProfileRecyclerViewAdapter;
...
public class ProfileFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        RecyclerView recyclerView = (RecyclerView) view.findViewById(R.id.recyvlerView_profile);

        GridLayoutManager gridLayoutManager = new GridLayoutManager(getContext(), 3);

        PictureProfileRecyclerViewAdapter pictureProfileRecyclerViewAdapter = new PictureProfileRecyclerViewAdapter(buidPicture(), R.layout.card_pet_profile, getActivity());

        recyclerView.setLayoutManager(gridLayoutManager);
        recyclerView.setAdapter(pictureProfileRecyclerViewAdapter);

        return view;
    }

    public ArrayList<CardViewProfile> buidPicture(){
        ArrayList<CardViewProfile> pictures = new ArrayList<CardViewProfile>();
        pictures.add(new CardViewProfile("https://images-wixmp-ed30a86b8c4ca887773594c2.wixmp.com/f/22c25b0c-a2e2-4140-a38b-010b64" +
                ...
                "Q1eCAMxykiJDavJip_Y70FECXzrrk0XefBT15go",   "15"));
        pictures.add(new CardViewProfile("https://images-wixmp-ed30a86b8c4ca887773594c2.wixmp.com/f/2e2ca105-22d3-44e7-ad36-b1ef4ac17cf7" +
                ...
                "cHxUZ869tg10aKVt8cqGfEiZi_-Mw", "15"));
        pictures.add(new CardViewProfile("https://images-wixmp-ed30a86b8c4ca887773594c2.wixmp.com/f/839ad802-cfe4-4f36-9be7-6a6d5d6c7302" +
                ...
                "FnZS5vcGVyYXRpb25zIl19.aL1NVpFRuB85b1eBRqQRcmhX2SnKveMA8QbbbmogqWk",  "15"));
        pictures.add(new CardViewProfile("https://images-wixmp-ed30a86b8c4ca887773594c2.wixmp.com/f/93aac52b-ed16-4e2d-b102-d27b478ea440" +
                ...
                "j0nk2IJ8okctP1V2I9SgfXi9sA",  "15"));
        pictures.add(new CardViewProfile("https://images-wixmp-ed30a86b8c4ca887773594c2.wixmp.com/f/538984eb-ab47-4c13-bfa8-b4f1aea20e2d/" +
                ...
                "pb25zIl19.3Cw6XyxaFd5Cy_3-LCK_IzBEz12-HfRTE8w3MZqlM4Q",  "15"));
        pictures.add(new CardViewProfile("https://images-wixmp-ed30a86b8c4ca887773594c2.wixmp.com/f/55aa2227-af96-4658-b918-97008446d62d/" +
                ...
                "toBC09ebyimR1goPWczqC0_aOXA1m0Bz6KlAhDWAlc",  "15"));
        pictures.add(new CardViewProfile("https://images-wixmp-ed30a86b8c4ca887773594c2.wixmp.com/f/4a510700-d63e-449c-82b7-525f770c9f14/" +
                ...
                "mwqeQ4nt7RNugeEQGS4TSb1Og",  "15"));
        pictures.add(new CardViewProfile("https://images-wixmp-ed30a86b8c4ca887773594c2.wixmp.com/f/abbe2a1f-5e26-4c10-b33b-68fb1ed57785/dd" +
