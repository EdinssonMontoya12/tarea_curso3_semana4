...
import com.edinsson.tarea3_4.adapter.PictureFiveFavoriteRecyclerViewAdapter;
import com.edinsson.tarea3_4.R;
import com.edinsson.tarea3_4.modelo.CardViewMain;
import com.edinsson.tarea3_4.presentador.FiveFavoritePresenter;
import com.edinsson.tarea3_4.presentador.IFiveFavoritePresenter;

import java.util.ArrayList;

public class fiveFavorites extends AppCompatActivity implements IFiveFavorite {

    private RecyclerView recyclerView;
    private IFiveFavoritePresenter iFiveFavoritePresenter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recyclerView = (RecyclerView) findViewById(R.id.recyclerview_five_favorite);
        iFiveFavoritePresenter = new FiveFavoritePresenter(this, this);
    }
    ...
    public void generarAdaptadorRecyclerView(ArrayList<CardViewMain> usuarios) {
        PictureFiveFavoriteRecyclerViewAdapter pictureFiveFavoriteRecyclerViewAdapter = new PictureFiveFavoriteRecyclerViewAdapter(usuarios, R.layout.card_pet_main, this);
